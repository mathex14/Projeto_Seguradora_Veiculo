...
import br.unipe.mtp3.dados.ConnectionDel;
import javafx.event.ActionEvent;
import javafx.event.EventHandler;

public class ButtonPressDel implements EventHandler<ActionEvent>{
	...
	public ButtonPressDel(Botoes b, Botoes bM, TextFields tf, Main_Menu mm) {
		this.b=b;
		this.bM=bM;
		this.tf=tf;
		this.mm=mm;
	...
	public void handle(ActionEvent event) {
		...
		ConnectionDel CDel= new ConnectionDel(this, mm);
		setVars();
